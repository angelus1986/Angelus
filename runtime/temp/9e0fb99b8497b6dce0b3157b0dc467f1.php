<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"D:\phpStudy\WWW\Angelus\public/../application/admin\view\index\index.html";i:1536636086;s:63:"D:\phpStudy\WWW\Angelus\application\admin\view\common\meta.html";i:1536636086;s:65:"D:\phpStudy\WWW\Angelus\application\admin\view\common\header.html";i:1536636086;s:63:"D:\phpStudy\WWW\Angelus\application\admin\view\common\menu.html";i:1536636086;s:66:"D:\phpStudy\WWW\Angelus\application\admin\view\common\control.html";i:1536636086;s:65:"D:\phpStudy\WWW\Angelus\application\admin\view\common\script.html";i:1536636086;}*/ ?>
<!DOCTYPE html>
...
<link rel="shortcut icon" href="/Angelus/public/assets/img/favicon.ico" />
<!-- Loading Bootstrap -->
<link href="/Angelus/public/assets/css/backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">

<!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
<!--[if lt IE 9]>
  <script src="/Angelus/public/assets/js/html5shiv.js"></script>
  <script src="/Angelus/public/assets/js/respond.min.js"></script>
<![endif]-->
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="/Angelus/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
                </li>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/Angelus/public<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                        <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="/Angelus/public<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/Angelus/public<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
...
<!-- /.control-sidebar -->
        ...
        <!-- 加载JS脚本 -->
        <script src="/Angelus/public/assets/js/require<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js" data-main="/Angelus/public/assets/js/require-backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo $site['version']; ?>"></script>
    </body>
</html>